...
public class OfferWallActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yesup_activity_offer_wall);
    ...
    public void onUserSelected(int opt) {
        ...
        OfferModel offer = offerWallAd.getOfferAt(offerIndex);
        if (offer != null) {
            if (offer.getJumpUrl() == null || offer.getJumpUrl().length() <= 0){
                curJumpUrlRequestId = offerwallController.requestOfferJumpUrlFromWebsite(offer);
    ...
    @Override
    public void onGetController(OfferwallController offerwallController) {
        this.offerwallController = offerwallController;
    }
    ...
    private void doProceed() {
        OfferModel offer = offerwallController.getOfferWallRequest().getOfferAt(offerIndex);
    ...
    private void gotoInstall() {
        ...
        if (offer != null) {
            ...
            offerwallController.saveOfferHasBeenClicked(offer);
            // jump to ad url
            String jumpUrl = offer.getJumpUrl();
            if (jumpUrl != null && jumpUrl.substring(0, 4).toLowerCase().equals("http")) {
