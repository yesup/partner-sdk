...
public class YesupHttpRequest {
    ...
    public void onRequestProgressed(int percent) {
        setPercent(percent);
        if (null != listener) {
            listener.onProgressed(this, percent);
        }
    }
    ...
    public static abstract class Listener {
        public abstract void onProgressed(YesupHttpRequest request, int percent);
        public abstract void onCompleted(YesupHttpRequest request, int result);
    }
